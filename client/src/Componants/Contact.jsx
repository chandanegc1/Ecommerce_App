  ...
  return (
    ...
    <div className="section123"> 
        ...
        <div className="section12345" >
            ...
            {/* style="padding: 10px; margin:50px 20px;" */}
                <p>GET IN TOUCH</p>
            ...
            <div className="mappart" > {/* style="padding: 10px; " */}
       ...
       <div className="form"  >
            <form onSubmit={handleSubmit}>
              ...
              <input type="text" required name='fullname' placeholder="Your Name" onChange={handleInputChange} /><br/>
              <p>E-mail:</p>
              <input type="email" required name='email'  placeholder="E-mail" onChange={handleInputChange} /><br/>
              <p>Subject:</p>
              <input type="text"  name='subject'  placeholder="Subject" onChange={handleInputChange} /><br/>
              <p>Message:</p>
              <input type="text" required name='message'  placeholder="Your Message" onChange={handleInputChange} /><br/><br/>
